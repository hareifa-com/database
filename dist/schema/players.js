...
export const players = pgTable('players', {
    ...
    dominant_foot: varchar('dominant_foot', { length: 5 }).notNull().$type(),
    /** Player's primary position */
    primary_position: varchar('primary_position', { length: 3 }).notNull().$type(),
    /** Player's secondary position (optional) */
    secondary_position: varchar('secondary_position', { length: 3 }).$type(),
    ...
    status: varchar('status', { length: 20 }).default('incomplete').$type(),
